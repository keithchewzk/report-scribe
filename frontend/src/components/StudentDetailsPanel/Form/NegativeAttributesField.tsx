...
interface NegativeAttributesFieldProps extends MultiSelectFieldProps {
  value: string[]
  onChange: (value: string[]) => void
}

const NegativeAttributesField: React.FC<NegativeAttributesFieldProps> = ({ value: selectedAttributes, onChange }) => {
  const predefinedAttributes = [
    "Needs to improve time management skills",
    "Could show more initiative in group work",
    "Should focus more during lessons",
    "Needs to develop better organization skills",
    "Could improve participation in class discussions",
    "Should work on following instructions more carefully",
    "Needs to improve homework completion consistency",
    "Could benefit from better peer interaction skills",
    "Should work on managing distractions",
    "Needs to develop stronger problem-solving persistence"
  ]
    ...
    <div style={{ marginBottom: '24px' }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <input
            ...
            placeholder="Enter custom area for improvement..."
            style={{
              flex: 1,
              padding: '8px 12px',
      ...
      {selectedAttributes.length > 0 && (
        <div style={{
          ...
          {selectedAttributes.length} area{selectedAttributes.length !== 1 ? 's' : ''} for improvement selected
        </div>
      )}
    </div>
  )
...
export default NegativeAttributesField